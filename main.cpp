...
int main(int argc, char *argv[])
{
	...
	if (level != 1)
		createDiamond(renderer, "image/diamond.bmp");
	...
	if (player_alive == true)
		win(renderer, score); // hinh anh win và diem so dat duoc
	else
		lose(renderer, score); // hinh anh game over
...
bool collision(Player player, int level)
{
	...
	if (n < 20 && m > 100 && m < 800)
		return true;
	if (m >= 20 && m < 100 && n > 300 && n < 340)
		return true;
	if (n > 140 && n < 180 && m > 180 && m < 320)
		return true;
	if (m > 180 && m < 220 && n > 140 && n < 320)
		return true;
	if (m > 180 && m < 540 && n > 280 && n < 320)
		return true;
	if (m > 500 && m < 540 && n > 280 && n < 440)
		return true;
	if (m > 300 && m < 540 && n > 400 && n < 440)
		return true;
	if (m > 300 && m < 340 && n > 400 && n < 520)
		return true;
	if (m > 180 && m < 340 && n > 480 && n < 520)
		return true;
	if (m > 420 && m < 460 && n >= 20 && n <= 300)
		return true;
	if (m > 500 && m < 540 && n > 500 && n < 600)
		return true;
	if (m > 620 && m < 660 && n >= 20 && n < 220)
		return true;
	if (m > 620 && m < 660 && n > 400 && n < 600)
		return true;
	if (m > 680 && m < 800 && n > 280 && n < 320)
		return true;
	return false;
}
